...
/**
 * If x is greater than the mid element, then x can only lie in the right side half
 * array after the mid element
 *
 * Else, if (x is smaller) then recur for the left half.
 */
